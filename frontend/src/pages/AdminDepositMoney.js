...
const AdminDepositMoney = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(`Deposit of ₹${amt} to ${res.data.customer.name} successful!`);
      setSelectedCustomer('');
      setAmount('');
      setDescription('');
    ...
    <div className="container py-4">
      <div className="row mb-4">
        <div className="col-12">
          <h1 style={{ color: '#003366' }}>💰 Deposit Money to Customer Account</h1>
          <p className="text-muted">Admin feature: Deposit funds to customer accounts</p>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-md-6">
          <form onSubmit={handleSubmit}>
            ...
            >
              {submitting ? 'Processing...' : 'Deposit Money'}
            </button>
            <button 
              type="button" 
...
export default AdminDepositMoney;
